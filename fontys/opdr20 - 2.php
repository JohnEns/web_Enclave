...
function pageLoad() {
    ...
    if (!isset($_COOKIE['theme'])) {
        ...
        $message = "Je themanummer is: " . $_COOKIE['theme'];
    }
    return $message;
}
...
<!-- <style>       
    ...
    <body>
        ...
        <h1>Opdracht 20 - Achtergrondkleur instellen - met MVC</h1>
        <h2>Opgave</h2>   
...
//}
        ...
        <form method="post">
            <table id='colorpick'>
                ...
                <tr><th></th><th></th></tr>
                <tr><td><p style='color:#000; background-color:#FFFF00'>Dit is het thema Kenteken</p></td><td> <p style='color:#FF0000; background-color:#00FF00'>Dit is het thema Buzz</p></td></tr>
...
//        echo "<h2><marquee>Dit is het thema " . $themeName . "</marquee></h2>";
//        echo $message;
